...
public class AdminOrderHistory extends AppCompatActivity {
        ...
        listing.enqueue(new Callback<Orderdetails>() {
            ...
            public void onResponse(Call<Orderdetails> call, Response<Orderdetails> response) {
                if(response.isSuccessful()){
                    ...
                    CustomAdepter customAdepter = new CustomAdepter(orders,AdminOrderHistory.this);
                    gridView.setAdapter(customAdepter);

                    Toast.makeText(AdminOrderHistory.this, "Succes", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(AdminOrderHistory.this, ""+response.code(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Orderdetails> call, Throwable t) {
                Toast.makeText(AdminOrderHistory.this, "Failure", Toast.LENGTH_SHORT).show();
            }
        });
    }
    class CustomAdepter extends BaseAdapter {
        ...
        public CustomAdepter(List<Order> orders, AdminOrderHistory adminOrderHistory) {
            this.orders = orders;
            this.context = adminOrderHistory;
