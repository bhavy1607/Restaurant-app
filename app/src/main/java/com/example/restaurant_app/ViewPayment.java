...
//
//        Call<cookdetails> listing = retrofitInterface.Getpayment();
//
...
//                    Toast.makeText(ViewPayment.this, "Success", Toast.LENGTH_SHORT).show();
//
//                }else{
//                    Toast.makeText(ViewPayment.this, ""+response.message(), Toast.LENGTH_SHORT).show();
//                }
//            }
//
//            @Override
